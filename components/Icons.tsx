...
export const MapIcon = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A2 2 0 013 15.485V6.515a2 2 0 011.053-1.777L9 2m0 18l6-3m-6 3V2m6 15l5.447 2.724A2 2 0 0021 17.915V8.945a2 2 0 00-1.053-1.777L15 4m0 13V4m0 0L9 2" />
  </svg>
);
...
export const NavigationIcon = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
