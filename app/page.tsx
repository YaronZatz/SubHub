           ...
           <div className="flex-1 overflow-y-auto p-3 md:p-4 custom-scrollbar bg-slate-50/30 min-h-0">
             ...
             {selectedSublet && (
               <div
                 ...
                 className="sticky bottom-4 left-0 right-0 mt-4 rounded-2xl overflow-hidden bg-white border-2 border-indigo-300 shadow-xl cursor-pointer hover:shadow-2xl hover:border-indigo-500 transition-all active:scale-[0.98] ring-2 ring-indigo-100 z-20"
               >
