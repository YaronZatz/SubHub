    ...
    <div className={`flex flex-col h-screen overflow-hidden bg-white ${isRTL ? 'font-sans' : ''}`}>
      ...
      <header className="bg-white border-b border-slate-200 px-2 sm:px-4 md:px-6 py-1 flex items-center justify-between z-[60] shadow-sm gap-1 sm:gap-2">
        ...
        <div className="flex items-center gap-1 sm:gap-2 min-w-0 shrink">
          <div className="flex items-center bg-slate-100 p-0.5 sm:p-1 rounded-full shrink-0">
            <button 
          ...
          {user ? (
            <>
              ...
              <div className="flex items-center gap-1 sm:gap-2 shrink-0">
                 <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-slate-900 text-white flex items-center justify-center font-bold text-xs border-2 border-slate-100">
            ...
            <button 
              ...
              className="bg-slate-900 text-white px-3 sm:px-5 py-1.5 sm:py-2 rounded-full hover:bg-black transition-all font-bold text-xs shadow-md shrink-0 whitespace-nowrap"
            >
              Log In
            </button>
          )}
             ...
             <div className="flex p-3 relative">
               ...
               <div className="flex-1 px-4 py-1 relative flex flex-col justify-between overflow-hidden">
                 <button 
                  ...
                  className="absolute top-1 right-1 z-30 bg-slate-900 hover:bg-black text-white w-7 h-7 rounded-full flex items-center justify-center transition-all active:scale-90 shadow-md"
                 >
